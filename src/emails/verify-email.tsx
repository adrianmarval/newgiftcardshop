...
export function VerifyEmailTemplate({ code, userName }: VerifyEmailProps) {
  return (
    <Html>
      ...
      <Preview>
        Your {process.env.NEXT_PUBLIC_APP_NAME || 'GiftCardShop'} verification code: {code}
      </Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={text}>
              Verify your email address to get started on {process.env.NEXT_PUBLIC_APP_NAME || 'GiftCardShop'}. Enter this code in the app:
            </Text>
