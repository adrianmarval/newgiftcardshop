...
export function TelegramOtpTemplate({ code, userName }: TelegramOtpProps) {
  return (
    <Html>
      <Head>
        <style>{`@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap');`}</style>
      </Head>
      <Preview>Tu código de verificación para Telegram: {code}</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={expiry}>Este código expira en 5 minutos.</Text>
          </Section>
...
export default TelegramOtpTemplate;
