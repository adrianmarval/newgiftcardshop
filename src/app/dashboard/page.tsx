      ...
      <div className="grid w-full grid-cols-1 gap-4 xl:grid-cols-2 2xl:grid-cols-3">
        ...
        <div className="rounded-lg bg-white p-4 shadow sm:p-6 xl:p-8 ">
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex-shrink-0">
              <Link href="#" className="rounded-lg p-2 text-sm font-medium text-cyan-600 hover:bg-gray-100">
                View all
              </Link>
            </div>
          </div>
                ...
                <div className="overflow-hidden shadow sm:rounded-lg">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                      <tr>
                        <th scope="col" className="p-4 text-left text-xs font-medium uppercase tracking-wider text-gray-500">
                          Transaction
                        </th>
                        <th scope="col" className="p-4 text-left text-xs font-medium uppercase tracking-wider text-gray-500">
                          Date & Time
                    ...
                    <tbody className="bg-white">
                      <tr>
                        ...
                        <td className="whitespace-nowrap p-4 text-sm font-normal text-gray-500">Apr 23 ,2021</td>
                      ...
                      <tr>
                        ...
                        <td className="whitespace-nowrap p-4 text-sm font-normal text-gray-500">Apr 18 ,2021</td>
                      ...
                      <tr className="bg-gray-50">
                        ...
                        <td className="whitespace-nowrap p-4 text-sm font-normal text-gray-500">Apr 15 ,2021</td>
                      ...
                      <tr className="bg-gray-50">
                        ...
                        <td className="whitespace-nowrap p-4 text-sm font-normal text-gray-500">Apr 11 ,2021</td>
                      ...
                      <tr>
                        ...
                        <td className="whitespace-nowrap p-4 text-sm font-normal text-gray-500">Apr 6 ,2021</td>
