...
import { UserRateAvatar } from '@/offers/giftcards/components/UserRateAvatar';
...
export const OfferCard = ({ offer }: Props) => {
  const { storeName, countryCode, totalAmount, currency, availableCards, offerId, seller } = offer;
