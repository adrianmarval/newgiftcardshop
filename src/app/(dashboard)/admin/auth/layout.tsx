...
export default function AdminAuthLayout({ children }: { children: ReactNode }) {
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#120a1f] p-6">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,var(--tw-gradient-stops))] from-violet-900/20 via-[#120a1f] to-[#120a1f]" />
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="mb-12 text-center">
          <h2 className="text-3xl font-light tracking-tight text-white">
            <span className="font-semibold text-violet-400">{process.env.NEXT_PUBLIC_APP_NAME || 'GiftCardShop'}</span> Admin
          </h2>
