...
export default async function AdminPaymentsPage({
  ...
  const paymentsResult = await listPayments(input);
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      <AdminPaymentsView payments={paymentsResult.data.items} pagination={paymentsResult.data.pagination} initialInput={input} />
    </div>
  );
}
