  ...
  return (
    <nav className="grid h-svh w-full grid-cols-1 grid-rows-[1fr_auto] gap-1 p-1 md:gap-4 md:p-4">
      ...
      <main className="bg-background relative col-span-1 overflow-hidden rounded-lg md:col-span-1">
        <div className="custom-scrollbar text-muted-foreground mx-auto h-full max-w-7xl overflow-y-auto italic md:p-2">{children}</div>
      </main>
      {/* 3: NAV/FOOTER - Full width always */}
      <footer className="bg-card/80 col-span-1 mx-auto flex w-full max-w-7xl items-center justify-center rounded-lg border p-3 shadow-lg backdrop-blur-xl md:col-span-1">
