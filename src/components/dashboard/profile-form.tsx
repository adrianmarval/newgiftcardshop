...
import { AlertCircle, CheckCircle, User, Lock, ShieldCheck, QrCode } from "lucide-react";
          ...
          {!twoStepEnable ? (
            <div className="space-y-4 py-4">
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                ...
                <p className="text-sm">We highly recommend enabling 2FA to keep your gift card portal secure.</p>
              </div>
