...
import { Trash2, Plus, Search, Edit2, Coins, Link2, Unlink } from 'lucide-react';
...
import { createCoin, updateCoin, deleteCoin, toggleCoinActive, addNetworkToCoin, removeNetworkFromCoin } from '@/actions/admin/coins';
...
export function CoinsTab({ coins, networks, searchQuery, onSearchChange, onChanged, tabButtons }: CoinsTabProps) {
      ...
      <Card className="flex w-full shrink-0 flex-col overflow-hidden md:w-1/3 md:min-w-[320px]">
        <CardHeader className="pb-2">
          ...
          <div className="relative mt-2">
            ...
            <Input placeholder="Search coins..." value={searchQuery} onChange={(e) => onSearchChange(e.target.value)} className="pl-9" />
          </div>
        </CardHeader>
