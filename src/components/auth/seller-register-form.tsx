    ...
    <Card className="w-full max-w-md mx-auto p-8">
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">Create your seller account to start listing gift cards</p>
        </div>
        ...
        <p className="text-sm text-muted-foreground text-center">
          ...
          <Link href="/sell/auth/login" className="text-primary hover:underline font-medium">
            Sign in
          </Link>
        </p>
      </div>
