...
export function SearchStep() {
  ...
  const handleSearch = async () => {
    ...
    const mockCards = [
      ...
      { id: "3", brand: selectedBrand, amount: amount - Math.floor(amount * 0.8), claimCode: "ZZZZ-ZZZZ-ZZZZ-ZZZZ", status: "UNUSED" as const },
    ].filter(c => c.amount > 0);
    ...
    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 h-full items-start">
      ...
      <Card className="md:col-span-4 border-border bg-card/50 backdrop-blur-sm p-3 md:p-6 space-y-4 md:space-y-6 flex flex-col h-auto md:h-full sticky top-0 z-20">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5 md:space-y-2">
            <Label className="text-muted-foreground text-[10px] md:text-xs font-semibold uppercase tracking-wider mb-1 block">Target Total Amount</Label>
