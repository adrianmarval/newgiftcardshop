    ...
    <div className="grid grid-cols-1 items-start gap-4 md:grid-cols-12 md:gap-6">
      ...
      <Card className="border-border bg-card/50 sticky top-0 z-20 flex h-auto flex-col space-y-3 p-3 backdrop-blur-sm md:col-span-4 md:h-full md:space-y-6 md:p-6">
        <div>
          ...
          <p className="text-muted-foreground hidden text-xs md:block md:text-base">Final review before publishing.</p>
        </div>
        ...
        <div className="space-y-3 md:space-y-4">
          {noEvidenceCount > 0 && (
            <div className="rounded-xl border border-slate-500/20 bg-slate-500/5 p-3 md:p-4">
              <p className="text-sm font-semibold text-slate-300">Non-blocking warnings</p>
              <p className="mt-1 text-sm text-slate-400">
                You can publish even if there are cards without capture or unassigned captures. This does not block this batch.
              </p>
            </div>
          )}
          ...
          <div className="border-primary/20 bg-primary/5 space-y-2 rounded-xl border p-3 md:p-4">
            ...
            <p className="text-muted-foreground text-sm italic">Payment will be processed once confirmed by buyers.</p>
          </div>
        </div>
      ...
      <Card className="border-border bg-card/50 flex min-h-100 flex-col p-4 backdrop-blur-sm md:col-span-8 md:min-h-125 md:p-6">
        <div className="mb-4 flex items-center justify-between md:mb-6">
          <Label className="text-muted-foreground text-sm font-semibold tracking-wider uppercase md:text-sm">Cards</Label>
            ...
            return (
              ...
              >
                ...
                <div className="mt-3 space-y-1">
                  ...
                  {card.source === 'ocr' && (
                    <div className="flex justify-between text-sm">
                      <span className="text-muted-foreground tracking-tighter uppercase">Source</span>
