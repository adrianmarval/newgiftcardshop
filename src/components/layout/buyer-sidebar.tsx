...
import { IconDashboard, IconSearch, IconShoppingCart, IconWallet, IconSettings } from "@tabler/icons-react";
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild className="data-[slot=sidebar-menu-button]:p-1.5!">
              <Link className="flex items-center" href="/buy/dashboard">
                <span className="text-3xl font-semibold">Solmaira Buy</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
