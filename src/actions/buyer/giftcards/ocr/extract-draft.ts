...
const extractDraftOutputSchema = z.union([
  z.object({
    ...
    ignoredImages: z.array(z.object({ imageId: z.string(), reason: z.enum(['unreadable', 'unmatched']) })),
  }),
...
export const extractDraft = sellerActionClient
  ...
  .outputSchema(extractDraftOutputSchema)
