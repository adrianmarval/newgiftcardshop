...
import { deleteBatchInputSchema, deleteBatchOutputSchema } from '@/types/domain/admin';

export const adminBatchDelete = adminActionClient
  ...
  .action(async ({ parsedInput }) => {
    ...
    if (hasOrders) {
      return { error: 'Cannot delete batch with cards that have orders' };
    }
