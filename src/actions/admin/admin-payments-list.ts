...
import { getAdminPaymentsInputSchema, getAdminPaymentsOutputSchema } from '@/types/domain/admin';
import { PaymentDirection, PaymentCategory } from '@/generated/prisma/enums';

export const adminPayments = adminActionClient
  .inputSchema(getAdminPaymentsInputSchema)
  .outputSchema(getAdminPaymentsOutputSchema)
